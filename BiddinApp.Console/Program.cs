        ...
        switch (optiune)
        {
            ...
            case 12:
                ...
                { 
                    ...
                    string path = $@"C:\Users\Asus ZenBook\Desktop\BiddingApp\BiddinApp.Console\Reviews\{numeProdus1}By{clientname2}.txt";
            ...
            case 13:
                try
                {
                    ...
                    Console.ForegroundColor = ConsoleColor.DarkGreen;
                    string path = $@"C:\Users\Asus ZenBook\Desktop\BiddingApp\BiddinApp.Console\Reviews\{numeProdus}By{clientname1}.txt";
                    File.WriteAllText(path, textnou);
                    Console.WriteLine("Review actualizat cu succes!");
                }
                catch (ArgumentNullException)
                {
                    Console.ForegroundColor = ConsoleColor.Red;
            ...
            case 14:
                ...
                try
                {
                    ...
                    Console.ForegroundColor = ConsoleColor.DarkGreen;
                    string path = $@"C:\Users\Asus ZenBook\Desktop\BiddingApp\BiddinApp.Console\Reviews\{numeProdus3}By{clientname3}.txt";
                    File.Delete(path);
